...
(function(){var proto=Core.createClass("Sound");
    ...
    proto.get_loop=function(){
        return this.node.loop;
    }
    proto.set_loop=function(v){
        this.node.loop=v;
    }
...
(function(){var proto=Core.createClass("Dlg",Box);
    Dlg.self;
    Dlg.start=function(title,doBack){
        if(!Dlg.self) new Dlg();
...
(function(){var proto=Core.createClass("Main",Box);
    ...
    proto.playLose=function(){
        this.bgm.pause();
        this.bgm.currentTime=0;
        Dlg.start("Your lose!",[this,this.start]);
    }

    proto.checkHit=function(hitter,type){
        for(var i=0;i<this.map.children.length;i++){
